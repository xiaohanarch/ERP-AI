...
python scripts/demo/scene_11.py  # 元数据自动喂养（投影段生成）+ 本体驱动（派生字段 API）
...
scripts/                  检验体系（tenant_checks/selfcheck/gen_report）+ demo 十一幕 + headless
...
| [docs/demo-script.md](docs/demo-script.md) | 十一幕演示剧本（讲解词 + 断言 + 浏览器路径） |
